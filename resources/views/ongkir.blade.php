...
<head>
    ...
    <title>Laravel Raja Ongkir - Test Skill</title>
</head>
<body style="background: #f3f3f3">
<div class="container-fluid mt-5">
    <h3 class="text-center">Raja Ongkir</h3>
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control provinsi-asal" readonly name="province_origin">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control kota-asal" readonly name="city_origin">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control provinsi-tujuan" required name="province_destination">
                            <option value="0">-- pilih provinsi tujuan --</option>
                               @foreach ($data as $province => $value)
                                <option value="{{ $value  }}">{{ $province }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="font-weight-bold">KOTA / KABUPATEN TUJUAN</label>
                        <select class="form-control kota-tujuan" required name="city_destination">
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    if (response) {
                        ...
                        $.each(response.data[0]['costs'], function (key, value) {
                            console.log(value)
                            ...
                            $('#ongkir').append('<li class="list-group-item"> <strong>'+value.service+'</strong> - Rp. '+value.cost[0].value+' ('+value.cost[0].etd+' hari)</li>')
                        });
